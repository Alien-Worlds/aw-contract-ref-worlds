  ...
  extends MongoMapper<Updateconfig, UpdateconfigMongoModel>
{
  ...
  public toEntity(mongoModel: UpdateconfigMongoModel): Updateconfig {
    ...
    return Updateconfig.create(
      config ? new SetConfigItemMongoMapper().toEntity(config) : SetConfigItem.getDefault(),
      dac_id || '',
...
export class SetConfigItemMongoMapper
  extends MongoMapper<SetConfigItem, SetConfigItemMongoModel>
{
  constructor() {
    super();
  ...
  extends MapperImpl<Updateconfig, UpdateconfigRawModel>
{
  ...
  public toEntity(rawModel: UpdateconfigRawModel): Updateconfig {
    ...
    return Updateconfig.create(
      config ? new SetConfigItemRawMapper().toEntity(config) : SetConfigItem.getDefault(),
      dac_id || '',
      undefined,
      rest
    );
